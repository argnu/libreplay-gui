...
export class APlayer {
    ...
    constructor(option) {
        ...
        const eventTypes = ['play', 'pause', 'canplay', 'playing', 'ended', 'error', 'save', 'destroy'];
        this.event = {};
        ...
        this.trigger = (type, args) => {
            for (let i = 0; i < this.event[type].length; i++) {
                if (args) this.event[type][i](...args);
                else this.event[type][i]();
            }
        };
                ...
                <div class="aplayer-controller">
                    ...
                    <div class="aplayer-time">
                        ...
                        <div class="aplayer-volume-wrap">
                            ...
                            this.getSVG('volume-down') + `</button>
        ...
        this.element.getElementsByClassName('aplayer-icon-menu')[0].addEventListener('click', () => {
            list.style.height = this.option.music.length * 35 + 'px';
    ...
    refreshPlaylist() {
      ...
      for (let i = 0; i < this.option.music.length; i++) {
          newItemHTML += `
              <li>
                  <button type="button" class="aplayer-icon aplayer-icon-remove" style="margin-right:1px"> ${this.getSVG('remove')} </button>
                  <span class="aplayer-list-cur" style="background: ${this.option.theme};"></span>
                  <span class="aplayer-list-index">${i + 1}</span>
                  <span class="aplayer-list-title">${this.option.music[i].title}</span>
                  <span class="aplayer-list-author">${this.option.music[i].author}</span>
      ...
      let elems = listEle.getElementsByClassName('aplayer-icon-remove');
